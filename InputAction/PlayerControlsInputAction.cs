    ...
    ""maps"": [
        {
            ...
            ""id"": ""638a0d70-4887-4df1-aa31-aa4adc8ffb05"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""3294846a-0665-45fd-b4f6-b1065a11dbe1"",
                ...
                },
                {
                    ""name"": ""Shoot"",
                    ""type"": ""Button"",
                    ""id"": ""006cd1e5-1be1-4fd9-a871-edf1fc7e9103"",
                ...
                },
                {
                    ""name"": ""ShootAngle"",
                    ""type"": ""Value"",
                    ""id"": ""19d0a87f-8a91-45c9-ae3e-5d254246f608"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""bc9c123a-e163-49fe-89e7-fa6f8e488995"",
                ...
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""89b07f31-2ee9-445f-bfb1-54a05e38235f"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""be098126-6580-4eb5-b554-2180af51b44f"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""52961841-1050-4e81-b952-eb8367d2d572"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""a0083037-5a2e-4cc0-a996-a6399cf3143e"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""71e398ed-5d23-4ff6-90cb-e433a0c9e890"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""6fef94c6-69fe-4f8d-acff-62ef7d4ccf10"",
                ...
                {
                    ""name"": """",
                    ""id"": ""043c3aed-bf54-4f33-973d-48225172a6d6"",
